...
5) Με το find -ls βρίσκουμε ότι το μοναδικό αρχείο με 1033 bytes ειναι εχει path ./inhere/maybehere07/.file2  . μπαίνουμε στον φάκελο maybehere07 και κάνουμε cat .file2
6) 
